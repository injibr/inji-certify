...
public class EcaVelocityTemplatingEngineImpl implements VCFormatter {
    ...
    public String format(JSONObject valueMap, Map<String, Object> templateSettings) {
        ...
        while(keys.hasNext()) {
            ...
            } else if (value instanceof Boolean || value instanceof Integer | value instanceof Float | value instanceof Long | value instanceof Double| value instanceof BigDecimal) {
