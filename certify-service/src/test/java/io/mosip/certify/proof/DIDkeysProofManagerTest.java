...
public class DIDkeysProofManagerTest {
    ...
    void testGetKeyFromHeader_WhenKeyIDIsEd25519() {
        // Mock JWSHeader
        JWSHeader header = Mockito.mock(JWSHeader.class);
        String keyID = "did:key:literal:REDACTED";
    ...
    void testGetKeyFromHeader_p256() {
        ...
        String keyID = "did:key:literal:REDACTED"; // Valid EC key ID for below key
    ...
    void testGetKeyFromHeader_genKeySECPK1_multipleKeys() throws JOSEException {
        ...
        JWSHeader jwsHeader = new JWSHeader.Builder(JWSAlgorithm.RS256)
                .jwk(jwk.toPublicJWK())
                .keyID("did:key:literal:REDACTED")
    ...
    void testGetDID_WhenKeyIDIsDIDKey() {
        JWSHeader header = Mockito.mock(JWSHeader.class);
        String didKey = "did:key:literal:REDACTED";
