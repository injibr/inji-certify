...
public class CCIRTokenClient {
    ...
    public CCIRTokenClient(
            WebClient webClient,
            @Value("${ccir.token.url}") String tokenUrl,
            @Value("${ccir.client.id}") String clientId,
            @Value("${ccir.client.secret}") String clientSecret,
